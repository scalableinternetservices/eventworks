...
usage="Usage: deploy-ecs.sh [eventworks-app-web|eventworks-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/eventworks:$2"
...
aws ecs update-service --cluster eventworks \
  --no-cli-pager \
  --region "$ecs_region" \
