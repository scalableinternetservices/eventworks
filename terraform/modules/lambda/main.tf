...
# Lambda URIs are "{+lambda}/{+function}" e.g. "eventworks/ping".
# We also support path matching at the root e.g. "eventworks" but these require definining separate "_root" terraform resources.
